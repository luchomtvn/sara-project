...
class TestSoilgridsSource(unittest.TestCase):
    ...
    def test_get_raster_files(self):
        ...
        self.assertTrue(Path(settings.soilgrids_dir + 'UY_0_5_mean.tif').is_file())
        self.assertTrue(Path(settings.soilgrids_dir + 'UY_5_15_mean.tif').is_file())
        self.assertTrue(Path(settings.soilgrids_dir + 'UY_15_30_mean.tif').is_file())
